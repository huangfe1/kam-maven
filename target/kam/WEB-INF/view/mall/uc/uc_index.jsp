    ...
    <div class="row">
        ...
        <div class="col-xs-6">
            ...
            <a class="thumbnail" href="#">
                ...
                <c:if test="${agentCode!=null}">
                <a class="thumbnail" href="<c:url value='/vmall/uc/dmz/promoCode.html/${user.agentCode}'/>">
                    </c:if>
...
<div class="container">
    ...
    <c:if test="${user.agentCode==null}">
        <div class="row">
            <div class="col-xs-12">
                <a class="btn btn-warning btn-block btn-lg" href="#"
                   id="wsxx">
                    <span class="glyphicon glyphicon-penci"></span>完善信息
                </a>
            </div>
        </div>
        <br>
...
<c:if test="${user.agentCode!=null}">
    ...
    <div class="row">
        <div class="col-xs-12">
            <a class="btn btn-success btn-block btn-lg" href="<c:url value='/agent/children.html?from=${user.id}'/>"
               id="sw">
    ...
    <div class="row">
        <div class="col-xs-12">
            <a class="btn btn-success btn-block btn-lg"
               href="<c:url value='/stats/market/index.html?agentCode=${user.agentCode}'/>" id="sw">
    ...
    <div class="row">
        <div class="col-xs-12">
            <a class="btn btn-success btn-block btn-lg" href="<c:url value='/delivery/mobile.html?from=${user.id}'/>"
               id="sw">
    ...
    <div class="row">
        <div class="col-xs-12">
            <a class="btn btn-warning btn-block btn-lg" href="<c:url value='/transfer/records.html?from=${user.id}'/>"
               id="sw">
    ...
    <div class="row">
        <div class="col-xs-12">
            <a class="btn btn-warning btn-block btn-lg" href="<c:url value='/logistFee/my.html'/>" id="sw">
                <span class="glyphicon glyphicon-plane"></span>&nbsp转物流费
            </a>
        </div>
    </div>
    <br>
    ...
    <div class="row">
        <div class="col-xs-12">
            <a class="btn btn-info btn-block btn-lg" href="<c:url value='/logistFee/pay/index.html'/>" id="sw">
...
<c:if test="${user.agentCode!=null}">
    ...
    <%--<div class="row">--%>
        <%--<div class="col-xs-12">--%>
            <%--<button class="btn btn-info btn-block btn-lg" type="button" id="sw"><span--%>
                    <%--class="glyphicon glyphicon-th-list"></span>&nbsp我的订单--%>
            <%--</button>--%>
                ...
                <%--<c:forEach items="${orders}" var="order">--%>
                    <%--<div class="panel panel-success">--%>
                        <%--<div class="panel-heading">订单号:${order.orderNo}&nbsp;--%>
                            <%--<h4>--%>
                                <%--<small>下单时间:<fmt:formatDate type="BOTH" pattern="yyyy年MM月dd日 HH:mm:ss"--%>
                                                            <%--value="${order.applyTime}"/></small>--%>
                            <%--</h4>--%>
                            <%--<h4>--%>
                                <%--<small>物流单号:${order.logisticsCode}</small>--%>
                            <%--</h4>--%>
                            <%--<h4>--%>
                                <%--<small>物流公司:${order.logistics}</small>--%>
                            <%--</h4>--%>
                        <%--</div>--%>
                        <%--<div class="table-responsive">--%>
                            <%--<table class="table">--%>
                        ...
                        <%--<c:if test="${order.status eq 'NEW' }">--%>
                            <%--<div class="panel-footer">--%>
                                <%--<button class="btn btn-warning btn-xs revokeBtn"--%>
                                        <%--data-id="${order.id}">撤销订单--%>
                                <%--</button>--%>
                            <%--</div>--%>
                        <%--</c:if>--%>
                    <%--</div>--%>
...
<jsp:include page="/WEB-INF/view/common/registerModal.jsp"></jsp:include>
