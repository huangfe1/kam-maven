...
<div class="container" id="nav">
    <div class="row">
        ...
        <div class="col-xs-3">
            <a class="thumbnail"
                            href="<c:url value='/dmz/pmall/tc/index.html'/>"
            > <img data-src="" alt=""
...
<form class="form-horizontal" role="search"
    ...
    <div class="container">
        <div class="form-group">
            ...
            <%--<img alt="Brand"  style="height: 20px" src="<c:url value='/resources/images/title-1.png'/>">--%>
            <%--</div>--%>
            <%--</div>--%>
            <div class="col-xs-12" >
                <div class="input-group">
                    <%--<span class="input-group-addon"><span class=" glyphicon glyphicon-search"></span></span>--%>
                    <input type="search" class="form-control " name="entity.name" value="${parameter.entity.name}"
...
<input type="hidden" id="pt" value="${parameter.entity.mallGoodsType.id}">
    ...
    $(function() {
        ...
        var query = function() {
            ...
            var param = {
                ...
                "entity.mallGoodsType.id" : $("#pt").val(),
                "start" : $("#start").val(),
                "length" : $("#length").val(),
                "useDatatables" : true
            };
