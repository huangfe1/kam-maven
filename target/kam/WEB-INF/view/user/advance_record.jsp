				...
				<div class="container-fluid">
					...
					<div class="col-md-12 col-xs-12">
						...
						<div class="form-group">
							...
							<label class="">支出/收入</label>
							<select name="entity.type" class="form-control">
								<option value="0" <c:if test="${parameter.entity.type==0}">selected</c:if>>支出</option>
								<option value="1"  <c:if test="${parameter.entity.type==1}">selected</c:if>>收入</option>
							</select>
