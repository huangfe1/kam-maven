                        ...
                        <div class="tab-content">
                            <div role="tabpanel" class="tab-pane active" id="basicInfo">
                                <div class="col-md-12 col-xs-12">
                                    ...
                                    <div class="form-group">
                                        <label for="currentPoint" class="col-sm-2 control-label">密码</label>
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" id="editIdCard"
                                                   tabIndex="13" required name="password"
                                                   value="${parameter.entity.password}" placeholder="密码">
                                        </div>
                                        <div class="col-md-4 col-xs-4 text-error"></div>
                                    </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-default viewBtn" target="letter"
                                           href="<c:url value='/auth/letter.html?id=${auth.id}'/>" data-id="${l.id}">查看证书</a>
