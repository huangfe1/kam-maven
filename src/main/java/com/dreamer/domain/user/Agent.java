...
public class Agent extends User {
	...
	private Set<LogistFeeRecord> logistFeeRecords = new HashSet<>();
...
//	}
    ...
    public void transferLogistFee(Agent toAgent,Double advance){
        getAccounts().transferLogistFeeToAnother(toAgent.getAccounts(),advance);
    }
    ...
    @Override
    public void addLogistFeeRecord(Integer type, String more, Double fee) {
        Timestamp updateTime = new Timestamp(System.currentTimeMillis());
        LogistFeeRecord a = new LogistFeeRecord(type,this,fee,more,getAccounts().getLogisticsFeeBalance(),updateTime);
        a.setHasNoticed(0);//需要通知
        logistFeeRecords.add(a);
    }
    ...
    public Set<LogistFeeRecord> getLogistFeeRecords() {
        return logistFeeRecords;
    }

    public void setLogistFeeRecords(Set<LogistFeeRecord> logistFeeRecords) {
        this.logistFeeRecords = logistFeeRecords;
    }
