...
public interface AgentHandler {
	...
	Agent bulidAgent(Agent newAgent, Agent agent);
	...
	public abstract void georganizeChildrens(User operator, Agent agent);
	...
	public abstract void transferVoucher(User operator, VoucherTransfer transfer,
	 ...
	 void transferAdvance(User operator, AdvanceTransfer transfer,
                          String toAgentCode, String toAgentName, Double advance);

	void transferLogistFee(User operator, LogistFeeTransfer transfer,
	...
	public abstract void addLogistFee(User operator, LogistFeeTransfer transfer);
	...
	public abstract void payForLogistFee(String time, LogistFeeTransfer transfer);
    ...
    Agent bulidVisitor(String openid, String nickName, String headimgurl);
