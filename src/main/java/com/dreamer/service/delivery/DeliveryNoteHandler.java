...
public class DeliveryNoteHandler {
	...
	public void addDeliveryNote(DeliveryNote note, String consigneeAgentCode,
		...
		//少于20，不让发货
//		if(note.getUserByApplyAgent().getAccounts().getLogisticsFeeBalance()<20){
//			throw new ApplicationException("物流费余额至少20元，请去用户中心充值");
//		}
...
//		}
        note.getUserByApplyAgent().getAccounts().deductLogistFee(actual_logisticsFee,"洗眼液发货扣除,订单"+note.getOrderNo());
		deliveryNoteDAO.merge(note);
	}
