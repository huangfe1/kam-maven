...
public class MallGoodstypeController {
	...
	public Message edit(
			@ModelAttribute("parameter") MallGoodsType parameter, @RequestParam(value="imgFile",required=false) MultipartFile file,
	...
	public Message delete(
			@ModelAttribute("parameter") MallGoodsType parameter,
	...
	public MallGoodsType preprocess(
			@RequestParam("id") Optional<Integer> id) {
		MallGoodsType goods = null;
		if (id.isPresent()) {
			goods =  mallGoodsDAO.findById(id.get());
		} else {
			goods = new MallGoodsType();
		}
		return goods;
	}
