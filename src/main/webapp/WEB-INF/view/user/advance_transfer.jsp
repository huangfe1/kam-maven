	...
	<form action="<c:url value='/advance/transfer.json'/>"
		...
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title text-primary" id="myModalLabel">代理置换券转账</h4>
			</div>
					...
					<div class="row">
						<div class="col-md-12 col-xs-12">
							...
							<div class="panel panel-primary">
								<div class="panel-heading">转出方置换券账户基本信息</div>
								<div class="panel-body">
									...
									<div class="form-group">
										<label class="col-sm-2 control-label">当前置换券余额</label>
										<div class="col-sm-6">
											<p class="form-control-static">${advanceBalance}</p>
										</div>
									</div>
								</div>
							</div>
							<div class="panel panel-danger">
								...
								<div class="panel-body">
									...
									<div class="form-group">
										<label for="advance" class="col-sm-2 control-label">转出置换券数量</label>
										<div class="col-sm-4">
											<input type="number" class="form-control" required
												id="advance" tabIndex="12" name="advance" value=""
												<c:if test="${advanceBalance<=0}">
										disabled="disabled"
										</c:if>
												placeholder="输入转出数量">
												<c:if test="${advanceBalance<=0}">
													<span class="help-block text-danger">置换券余额为0时无法转出</span>
												</c:if>
										</div>
										<div class="col-md-4 col-xs-4 text-error"></div>
									</div>
					...
					<div class="form-group">
						...
						<div class="col-md-6 col-xs-12">
							<button type="submit" class="btn btn-success btn-block"
								...
								<span class="glyphicon glyphicon-save">&nbsp;</span>转让置换券
							</button>
						</div>
					</div>
				</div>
