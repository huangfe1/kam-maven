								...
								<c:forEach items="${agents}" var="l">
									<tr data-row="${l.id}">
										...
										<span class="glyphicon glyphicon-new-window ">&nbsp;</span>账户明细</a>
											<a class="btn btn-warning " href="<c:url value='/securityCode/scan_num.html?owner=${l.realName}&&agentCode=${l.agentCode}' /> "><span class="glyphicon glyphicon-new-window ">&nbsp;</span>录入防伪</a></a>
