...
<body>
<br>
	<form action="<c:url value='/logistFee/pay/commit.json'/>"
	<%--<form action="<c:url value='/logistFee/pay/alicommit.json'/>"--%>
                        ...
                        <div class="col-md-12 col-xs-12">
                                ...
                                <div class="controls" align="center">
									<div class="input-group">
										<label>填写充值金额：</label>
										<input class="form-control"  type="text" id="fee" name="fee" placeholder="数量">
									</div>
                                </div>
										...
										.ajaxSubmit(
												{
													...
													success : function(
														...
														if (m.flag == "0") {
															$("#alertMessageBody").empty().html(m.message+",正在前往支付");
