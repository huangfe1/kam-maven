...
<div class="modal-dialog modal-lg" role="document">
	<form action="<c:url value='/logistFee/transfer.json'/>"
		...
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title text-primary" id="myModalLabel">代理物流费转账</h4>
			</div>
							...
							<div class="panel panel-primary">
								...
								<div class="panel-body">
									...
									<div class="form-group">
										...
										<div class="col-sm-6">
											<p class="form-control-static">${feeBalance}</p>
										</div>
									</div>
								</div>
							</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
											<input type="number" class="form-control" required
												id="fee" tabIndex="12" name="fee" value=""
												<c:if test="${feeBalance<=0}">
										disabled="disabled"
										</c:if>
												placeholder="输入转出数量">
												<c:if test="${feeBalance<=0}">
