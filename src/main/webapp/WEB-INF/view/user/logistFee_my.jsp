				...
				<div class="container-fluid">
					...
					<div class="col-sm-12 col-md-12 col-xs-12">
						<form class="navbar-form form-horizontal navbar-left" id="searchForm"
							role="search" action="<c:url value='/logistFee/my.html'/>"
							method="GET">

							<div class="form-group" >
                                <%--<label>转让人姓名</label>--%>
                                <%--<input type="text" class="form-control" value="${parameter.entity.userByFromAgent.agentCode}" name="userByFromAgent" />--%>
                                <%--<label>受让人姓名</label>--%>
                                <%--<input type="text" class="form-control" value="${parameter.entity.userByToAgent.agentCode}" name="userByToAgent" />--%>
							<label>转让时间</label>
...
//                        var m=$.parseJSON(xhr.responseText);
			...
			$(".transBtn").click(
					function(e) {
						...
						e.stopPropagation();
						$("#myModal").load(
								"<c:url value='/logistFee/transfer.html'/>",
								function(e) {
									$('#myModal').modal({
										backdrop : "static"
									});
