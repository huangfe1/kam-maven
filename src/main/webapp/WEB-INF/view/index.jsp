...
<c:if test="${user.admin and (user.loginName eq 'kam')}">
			<div class="row">
				...
				<%--<div class="col-lg-3 col-md-6">--%>
					<%--&lt;%&ndash;<div class="panel panel-green">&ndash;%&gt;--%>
						<%--&lt;%&ndash;<div class="panel-heading">&ndash;%&gt;--%>
							<%--&lt;%&ndash;<div class="row">&ndash;%&gt;--%>
								<%--&lt;%&ndash;<div class="col-xs-3">&ndash;%&gt;--%>
									<%--&lt;%&ndash;&lt;%&ndash;<i class="fa fa-tasks fa-5x"></i>&ndash;%&gt;&ndash;%&gt;--%>
								<%--&lt;%&ndash;</div>&ndash;%&gt;--%>
								<%--&lt;%&ndash;<div class="col-xs-12 ">&ndash;%&gt;--%>
									<%--&lt;%&ndash;<div class="huge">${sumVoucher}</div>&ndash;%&gt;--%>
									<%--&lt;%&ndash;<div>市场代金券总数</div>&ndash;%&gt;--%>
								<%--&lt;%&ndash;</div>&ndash;%&gt;--%>
							<%--&lt;%&ndash;</div>&ndash;%&gt;--%>
						<%--&lt;%&ndash;&lt;%&ndash;</div>&ndash;%&gt;&ndash;%&gt;--%>
						<%--&lt;%&ndash;<a href="<c:url value='#'/>">&ndash;%&gt;--%>
