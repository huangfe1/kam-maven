						...
						<div class="panel panel-primary">
							...
							<div class="panel-body">
								<div class="col-md-12 col-xs-12">
									...
									<div class="form-group">
										<label for="editWeixin" class="col-sm-2 control-label">物流费余额</label>
										<div class="col-sm-6">
											<input type="number" class="form-control" disabled tabIndex="12"
												   value="${parameter.entity.user.accounts.logisticsFeeBalance}" readonly
												  >
										</div>
										<div class="col-md-4 col-xs-4 text-error"></div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-6">
											<input type="number" class="form-control" tabIndex="12"
												   value="${parameter.entity.logisticsFee}" name="actualLogisticsFee"
												   placeholder="请填写实际要收取的物流费费用">
										</div>
										<div class="col-md-4 col-xs-4 text-error"></div>
									</div>
								</div>
