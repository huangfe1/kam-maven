                                ...
                                <div class="panel panel-red">
                                    ...
                                    <div class="panel-body">
                                        <div class="form-group">
                                            <label for="editName" class="col-sm-2 control-label">转出方姓名</label>
                                            <div class="col-sm-4">
                                                <input type="text" value="咖盟" name="userByFromAgent.realName" class="form-control"
                                                       id="esditName" tabIndex="12" required placeholder="输入转出方姓名">
                                            </div>
                                            <div class="col-md-4 col-xs-4 text-error"></div>
                                        </div>
                                        <div class="form-group">
                                            <label for="editAgentCode" class="col-sm-2 control-label">转出方代理编号</label>
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control" required
                                                       id="editAgentCode" value="01" tabIndex="12"
                                                       name="userByFromAgent.agentCode"
                                                       placeholder="转出方代理编号">
                                            </div>
                                            <div class="col-md-4 col-xs-4 text-error"></div>
                                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4 col-xs-4 text-error"></div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text"
                                            <c:if test="${toback eq 1}"> readonly='readonly' value="咖盟"</c:if>
                                                   name="userByToAgent.realName" class="form-control" id="esditName"
                                                   tabIndex="12" required placeholder="输入对方姓名">
                                        </div>
                                        <div class="col-md-4 col-xs-4 text-error"></div>
                                    </div>
                                    <div class="form-group">
